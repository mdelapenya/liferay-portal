...
public class LockPersistenceImpl extends BasePersistenceImpl<Lock>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(lock_.uuid_ IS NULL OR lock_.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(lock_.uuid_ IS NULL OR lock_.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_C_K_KEY_3 = "(lock_.key_ IS NULL OR lock_.key = '')";
