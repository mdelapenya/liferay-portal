...
public class RepositoryPersistenceImpl extends BasePersistenceImpl<Repository>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(repository.uuid_ IS NULL OR repository.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(repository.uuid_ IS NULL OR repository.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(repository.uuid_ IS NULL OR repository.uuid = '') AND ";
