...
public class UserPersistenceImpl extends BasePersistenceImpl<User>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(user_.uuid_ IS NULL OR user_.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(user_.uuid_ IS NULL OR user_.uuid = '') AND ";
