...
public class SubscriptionPersistenceImpl extends BasePersistenceImpl<Subscription>
	...
	public List<Subscription> findByUserId(long userId, int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(SubscriptionModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
			...
			try {
				...
				q.addEntity(_ENTITY_ALIAS, SubscriptionImpl.class);
	...
	public List<Subscription> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(SubscriptionModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_SUBSCRIPTION);
	...
	private static final String _SQL_COUNT_SUBSCRIPTION = "SELECT COUNT(*) AS COUNT_VALUE FROM Subscription subscription";
	private static final String _SQL_COUNT_SUBSCRIPTION_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM Subscription subscription WHERE ";
	private static final String _ENTITY_ALIAS = "subscription";
