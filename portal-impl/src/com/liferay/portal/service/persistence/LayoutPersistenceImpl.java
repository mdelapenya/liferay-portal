...
public class LayoutPersistenceImpl extends BasePersistenceImpl<Layout>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(layout.uuid_ IS NULL OR layout.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_P_UUID_3 = "(layout.uuid_ IS NULL OR layout.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(layout.uuid_ IS NULL OR layout.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_G_P_T_TYPE_3 = "(layout.type_ IS NULL OR layout.type = '')";
