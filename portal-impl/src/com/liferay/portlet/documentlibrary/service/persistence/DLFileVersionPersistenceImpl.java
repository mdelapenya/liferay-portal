...
public class DLFileVersionPersistenceImpl extends BasePersistenceImpl<DLFileVersion>
	...
	public List<DLFileVersion> findByUuid(String uuid, int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(DLFileVersionModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
			...
			try {
				...
				q.addEntity(_ENTITY_ALIAS, DLFileVersionImpl.class);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(dlFileVersion.uuid_ IS NULL OR dlFileVersion.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(dlFileVersion.uuid_ IS NULL OR dlFileVersion.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(dlFileVersion.uuid_ IS NULL OR dlFileVersion.uuid = '') AND ";
	...
	public List<DLFileVersion> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(DLFileVersionModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_DLFILEVERSION);
	...
	private static final String _SQL_COUNT_DLFILEVERSION = "SELECT COUNT(*) AS COUNT_VALUE FROM DLFileVersion dlFileVersion";
	private static final String _SQL_COUNT_DLFILEVERSION_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM DLFileVersion dlFileVersion WHERE ";
	private static final String _ENTITY_ALIAS = "dlFileVersion";
