...
public class DLContentPersistenceImpl extends BasePersistenceImpl<DLContent>
	...
	private static final String _FINDER_COLUMN_C_R_P_PATH_3 = "(dlContent.path_ IS NULL OR dlContent.path = '')";
	...
	private static final String _FINDER_COLUMN_C_R_LIKEP_PATH_3 = "(dlContent.path_ IS NULL OR dlContent.path LIKE '')";
	...
	private static final String _FINDER_COLUMN_C_R_P_V_PATH_3 = "(dlContent.path_ IS NULL OR dlContent.path = '') AND ";
