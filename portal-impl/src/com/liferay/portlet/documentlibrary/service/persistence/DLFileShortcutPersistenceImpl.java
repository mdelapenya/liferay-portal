...
public class DLFileShortcutPersistenceImpl extends BasePersistenceImpl<DLFileShortcut>
	...
	public List<DLFileShortcut> findByUuid(String uuid, int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(DLFileShortcutModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(dlFileShortcut.uuid_ IS NULL OR dlFileShortcut.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(dlFileShortcut.uuid_ IS NULL OR dlFileShortcut.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(dlFileShortcut.uuid_ IS NULL OR dlFileShortcut.uuid = '') AND ";
	...
	public List<DLFileShortcut> filterFindByG_F(long groupId, long folderId,
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(DLFileShortcutModelImpl.ORDER_BY_ENTITY_TABLE);
			}
		}
	...
	public List<DLFileShortcut> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(DLFileShortcutModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_DLFILESHORTCUT);
	...
	private static final String _SQL_COUNT_DLFILESHORTCUT = "SELECT COUNT(*) AS COUNT_VALUE FROM DLFileShortcut dlFileShortcut";
	private static final String _SQL_COUNT_DLFILESHORTCUT_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM DLFileShortcut dlFileShortcut WHERE ";
