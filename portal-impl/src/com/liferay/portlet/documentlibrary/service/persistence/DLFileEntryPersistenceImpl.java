...
public class DLFileEntryPersistenceImpl extends BasePersistenceImpl<DLFileEntry>
	...
	public List<DLFileEntry> findByUuid(String uuid, int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(DLFileEntryModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(dlFileEntry.uuid_ IS NULL OR dlFileEntry.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(dlFileEntry.uuid_ IS NULL OR dlFileEntry.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(dlFileEntry.uuid_ IS NULL OR dlFileEntry.uuid = '') AND ";
	...
	public List<DLFileEntry> filterFindByGroupId(long groupId, int start,
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(DLFileEntryModelImpl.ORDER_BY_ENTITY_TABLE);
			}
		}
	...
	public List<DLFileEntry> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(DLFileEntryModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_DLFILEENTRY);
	...
	private static final String _SQL_COUNT_DLFILEENTRY = "SELECT COUNT(*) AS COUNT_VALUE FROM DLFileEntry dlFileEntry";
	private static final String _SQL_COUNT_DLFILEENTRY_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM DLFileEntry dlFileEntry WHERE ";
