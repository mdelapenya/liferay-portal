...
public class MBBanPersistenceImpl extends BasePersistenceImpl<MBBan>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(mbBan.uuid_ IS NULL OR mbBan.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(mbBan.uuid_ IS NULL OR mbBan.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(mbBan.uuid_ IS NULL OR mbBan.uuid = '') AND ";
