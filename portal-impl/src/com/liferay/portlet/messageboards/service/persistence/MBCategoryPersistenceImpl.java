...
public class MBCategoryPersistenceImpl extends BasePersistenceImpl<MBCategory>
	...
	public List<MBCategory> findByUuid(String uuid, int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(MBCategoryModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(mbCategory.uuid_ IS NULL OR mbCategory.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(mbCategory.uuid_ IS NULL OR mbCategory.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(mbCategory.uuid_ IS NULL OR mbCategory.uuid = '') AND ";
	...
	public List<MBCategory> filterFindByGroupId(long groupId, int start,
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(MBCategoryModelImpl.ORDER_BY_ENTITY_TABLE);
			}
		}
	...
	public List<MBCategory> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(MBCategoryModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_MBCATEGORY);
	...
	private static final String _SQL_COUNT_MBCATEGORY = "SELECT COUNT(*) AS COUNT_VALUE FROM MBCategory mbCategory";
	private static final String _SQL_COUNT_MBCATEGORY_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM MBCategory mbCategory WHERE ";
