...
public class MBMailingListPersistenceImpl extends BasePersistenceImpl<MBMailingList>
	...
	public List<MBMailingList> findByUuid(String uuid, int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(MBMailingListModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
			...
			try {
				...
				q.addEntity(_ENTITY_ALIAS, MBMailingListImpl.class);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(mbMailingList.uuid_ IS NULL OR mbMailingList.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(mbMailingList.uuid_ IS NULL OR mbMailingList.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(mbMailingList.uuid_ IS NULL OR mbMailingList.uuid = '') AND ";
	...
	public List<MBMailingList> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(MBMailingListModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_MBMAILINGLIST);
	...
	private static final String _SQL_COUNT_MBMAILINGLIST = "SELECT COUNT(*) AS COUNT_VALUE FROM MBMailingList mbMailingList";
	private static final String _SQL_COUNT_MBMAILINGLIST_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM MBMailingList mbMailingList WHERE ";
	private static final String _ENTITY_ALIAS = "mbMailingList";
