...
public class CalEventPersistenceImpl extends BasePersistenceImpl<CalEvent>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(calEvent.uuid_ IS NULL OR calEvent.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(calEvent.uuid_ IS NULL OR calEvent.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(calEvent.uuid_ IS NULL OR calEvent.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_G_T_TYPE_3 = "(calEvent.type_ IS NULL OR calEvent.type = '')";
	...
	private static final String _FINDER_COLUMN_G_T_R_TYPE_3 = "(calEvent.type_ IS NULL OR calEvent.type = '') AND ";
