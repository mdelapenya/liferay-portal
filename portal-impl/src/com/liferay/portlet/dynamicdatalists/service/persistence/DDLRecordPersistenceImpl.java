...
public class DDLRecordPersistenceImpl extends BasePersistenceImpl<DDLRecord>
	...
	public List<DDLRecord> findByUuid(String uuid, int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(DDLRecordModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
			...
			try {
				...
				q.addEntity(_ENTITY_ALIAS, DDLRecordImpl.class);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(ddlRecord.uuid_ IS NULL OR ddlRecord.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(ddlRecord.uuid_ IS NULL OR ddlRecord.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(ddlRecord.uuid_ IS NULL OR ddlRecord.uuid = '') AND ";
	...
	public List<DDLRecord> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(DDLRecordModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_DDLRECORD);
	...
	private static final String _SQL_COUNT_DDLRECORD = "SELECT COUNT(*) AS COUNT_VALUE FROM DDLRecord ddlRecord";
	private static final String _SQL_COUNT_DDLRECORD_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM DDLRecord ddlRecord WHERE ";
	private static final String _ENTITY_ALIAS = "ddlRecord";
