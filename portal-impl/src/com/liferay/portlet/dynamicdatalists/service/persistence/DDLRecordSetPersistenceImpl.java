...
public class DDLRecordSetPersistenceImpl extends BasePersistenceImpl<DDLRecordSet>
	...
	public List<DDLRecordSet> findByUuid(String uuid, int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(DDLRecordSetModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
			...
			try {
				...
				q.addEntity(_ENTITY_ALIAS, DDLRecordSetImpl.class);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(ddlRecordSet.uuid_ IS NULL OR ddlRecordSet.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(ddlRecordSet.uuid_ IS NULL OR ddlRecordSet.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(ddlRecordSet.uuid_ IS NULL OR ddlRecordSet.uuid = '') AND ";
	...
	public List<DDLRecordSet> filterFindByGroupId(long groupId, int start,
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(DDLRecordSetModelImpl.ORDER_BY_ENTITY_TABLE);
			}
		}
	...
	public List<DDLRecordSet> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(DDLRecordSetModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_DDLRECORDSET);
	...
	private static final String _SQL_COUNT_DDLRECORDSET = "SELECT COUNT(*) AS COUNT_VALUE FROM DDLRecordSet ddlRecordSet";
	private static final String _SQL_COUNT_DDLRECORDSET_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM DDLRecordSet ddlRecordSet WHERE ";
	...
	private static final String _ENTITY_ALIAS = "ddlRecordSet";
