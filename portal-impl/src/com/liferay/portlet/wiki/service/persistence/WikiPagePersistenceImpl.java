...
public class WikiPagePersistenceImpl extends BasePersistenceImpl<WikiPage>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(wikiPage.uuid_ IS NULL OR wikiPage.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(wikiPage.uuid_ IS NULL OR wikiPage.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(wikiPage.uuid_ IS NULL OR wikiPage.uuid = '') AND ";
