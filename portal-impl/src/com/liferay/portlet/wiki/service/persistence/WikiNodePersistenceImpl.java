...
public class WikiNodePersistenceImpl extends BasePersistenceImpl<WikiNode>
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(wikiNode.uuid_ IS NULL OR wikiNode.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(wikiNode.uuid_ IS NULL OR wikiNode.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(wikiNode.uuid_ IS NULL OR wikiNode.uuid = '') AND ";
