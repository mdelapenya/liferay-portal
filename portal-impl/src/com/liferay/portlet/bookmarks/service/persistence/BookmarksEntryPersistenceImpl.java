...
public class BookmarksEntryPersistenceImpl extends BasePersistenceImpl<BookmarksEntry>
	...
	public List<BookmarksEntry> findByResourceBlockId(long resourceBlockId,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(BookmarksEntryModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(bookmarksEntry.uuid_ IS NULL OR bookmarksEntry.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(bookmarksEntry.uuid_ IS NULL OR bookmarksEntry.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(bookmarksEntry.uuid_ IS NULL OR bookmarksEntry.uuid = '') AND ";
	...
	public List<BookmarksEntry> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(BookmarksEntryModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_BOOKMARKSENTRY);
	...
	private static final String _SQL_COUNT_BOOKMARKSENTRY = "SELECT COUNT(*) AS COUNT_VALUE FROM BookmarksEntry bookmarksEntry";
	private static final String _SQL_COUNT_BOOKMARKSENTRY_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM BookmarksEntry bookmarksEntry WHERE ";
