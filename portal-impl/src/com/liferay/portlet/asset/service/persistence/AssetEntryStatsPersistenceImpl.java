...
public class AssetEntryStatsPersistenceImpl extends BasePersistenceImpl<AssetEntryStats>
	...
	public static final FinderPath FINDER_PATH_WITH_PAGINATION_FIND_BY_C_C = new FinderPath(AssetEntryStatsModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryStatsModelImpl.FINDER_CACHE_ENABLED,
			AssetEntryStatsImpl.class, FINDER_CLASS_NAME_LIST_WITH_PAGINATION,
			"findByC_C",
			new String[] {
	...
	public static final FinderPath FINDER_PATH_WITHOUT_PAGINATION_FIND_BY_C_C = new FinderPath(AssetEntryStatsModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryStatsModelImpl.FINDER_CACHE_ENABLED,
			AssetEntryStatsImpl.class,
	...
	public static final FinderPath FINDER_PATH_COUNT_BY_C_C = new FinderPath(AssetEntryStatsModelImpl.ENTITY_CACHE_ENABLED,
			AssetEntryStatsModelImpl.FINDER_CACHE_ENABLED, Long.class,
	 ...
	 */
	@Override
	public List<AssetEntryStats> findByC_C(long classNameId, long classPK)
	 ...
	 */
	@Override
	public AssetEntryStats findByC_C_First(long classNameId, long classPK,
		OrderByComparator orderByComparator)
		throws NoSuchEntryStatsException, SystemException {
		AssetEntryStats assetEntryStats = fetchByC_C_First(classNameId,
	 ...
	 */
	@Override
	public AssetEntryStats fetchByC_C_First(long classNameId, long classPK,
		OrderByComparator orderByComparator) throws SystemException {
		List<AssetEntryStats> list = findByC_C(classNameId, classPK, 0, 1,
				orderByComparator);
	 ...
	 */
	@Override
	public AssetEntryStats findByC_C_Last(long classNameId, long classPK,
		OrderByComparator orderByComparator)
		throws NoSuchEntryStatsException, SystemException {
		AssetEntryStats assetEntryStats = fetchByC_C_Last(classNameId, classPK,
				orderByComparator);
	 ...
	 */
	@Override
	public AssetEntryStats fetchByC_C_Last(long classNameId, long classPK,
		OrderByComparator orderByComparator) throws SystemException {
		...
		List<AssetEntryStats> list = findByC_C(classNameId, classPK, count - 1,
	 ...
	 */
	@Override
	public AssetEntryStats[] findByC_C_PrevAndNext(long entryStatsId,
		...
		try {
			...
			array[0] = getByC_C_PrevAndNext(session, assetEntryStats,
					classNameId, classPK, orderByComparator, true);

			array[1] = assetEntryStats;

			array[2] = getByC_C_PrevAndNext(session, assetEntryStats,
	...
	protected AssetEntryStats getByC_C_PrevAndNext(Session session,
		AssetEntryStats assetEntryStats, long classNameId, long classPK,
	...
	public void removeByC_C(long classNameId, long classPK)
		throws SystemException {
		for (AssetEntryStats assetEntryStats : findByC_C(classNameId, classPK,
	...
	private static final String _FINDER_COLUMN_C_C_CLASSNAMEID_2 = "assetEntryStats.classNameId = ? AND ";
	private static final String _FINDER_COLUMN_C_C_CLASSPK_2 = "assetEntryStats.classPK = ?";
	...
	public AssetEntryStats updateImpl(
		...
		if (isNew || !AssetEntryStatsModelImpl.COLUMN_BITMASK_ENABLED) {
			...
			if ((assetEntryStatsModelImpl.getColumnBitmask() &
				...
				args = new Object[] {
						assetEntryStatsModelImpl.getClassNameId(),
						assetEntryStatsModelImpl.getClassPK()
					};
