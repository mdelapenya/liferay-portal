...
public class MDRRuleGroupInstancePersistenceImpl extends BasePersistenceImpl<MDRRuleGroupInstance>
	...
	public List<MDRRuleGroupInstance> findByUuid(String uuid, int start,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(MDRRuleGroupInstanceModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
			...
			try {
				...
				q.addEntity(_ENTITY_ALIAS, MDRRuleGroupInstanceImpl.class);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(mdrRuleGroupInstance.uuid_ IS NULL OR mdrRuleGroupInstance.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(mdrRuleGroupInstance.uuid_ IS NULL OR mdrRuleGroupInstance.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(mdrRuleGroupInstance.uuid_ IS NULL OR mdrRuleGroupInstance.uuid = '') AND ";
	...
	public List<MDRRuleGroupInstance> filterFindByGroupId(long groupId,
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(MDRRuleGroupInstanceModelImpl.ORDER_BY_ENTITY_TABLE);
			}
		}
	...
	public List<MDRRuleGroupInstance> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(MDRRuleGroupInstanceModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_MDRRULEGROUPINSTANCE);
	...
	private static final String _SQL_COUNT_MDRRULEGROUPINSTANCE = "SELECT COUNT(*) AS COUNT_VALUE FROM MDRRuleGroupInstance mdrRuleGroupInstance";
	private static final String _SQL_COUNT_MDRRULEGROUPINSTANCE_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM MDRRuleGroupInstance mdrRuleGroupInstance WHERE ";
	...
	private static final String _ENTITY_ALIAS = "mdrRuleGroupInstance";
