...
public class MDRRuleGroupPersistenceImpl extends BasePersistenceImpl<MDRRuleGroup>
	...
	public List<MDRRuleGroup> findByUuid(String uuid, int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(MDRRuleGroupModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
			...
			try {
				...
				q.addEntity(_ENTITY_ALIAS, MDRRuleGroupImpl.class);
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(mdrRuleGroup.uuid_ IS NULL OR mdrRuleGroup.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(mdrRuleGroup.uuid_ IS NULL OR mdrRuleGroup.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(mdrRuleGroup.uuid_ IS NULL OR mdrRuleGroup.uuid = '') AND ";
	...
	public List<MDRRuleGroup> filterFindByGroupId(long groupId, int start,
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(MDRRuleGroupModelImpl.ORDER_BY_ENTITY_TABLE);
			}
		}
	...
	public List<MDRRuleGroup> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(MDRRuleGroupModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_MDRRULEGROUP);
	...
	private static final String _SQL_COUNT_MDRRULEGROUP = "SELECT COUNT(*) AS COUNT_VALUE FROM MDRRuleGroup mdrRuleGroup";
	private static final String _SQL_COUNT_MDRRULEGROUP_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM MDRRuleGroup mdrRuleGroup WHERE ";
	...
	private static final String _ENTITY_ALIAS = "mdrRuleGroup";
