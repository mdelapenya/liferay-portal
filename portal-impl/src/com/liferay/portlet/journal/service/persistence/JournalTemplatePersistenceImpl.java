...
public class JournalTemplatePersistenceImpl extends BasePersistenceImpl<JournalTemplate>
	...
	public List<JournalTemplate> findByUuid(String uuid, int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
			 ...
			 if (pagination) {
				query.append(JournalTemplateModelImpl.ORDER_BY_ENTITY_ALIAS);
			}
	...
	private static final String _FINDER_COLUMN_UUID_UUID_3 = "(journalTemplate.uuid_ IS NULL OR journalTemplate.uuid = '')";
	...
	private static final String _FINDER_COLUMN_UUID_G_UUID_3 = "(journalTemplate.uuid_ IS NULL OR journalTemplate.uuid = '') AND ";
	...
	private static final String _FINDER_COLUMN_UUID_C_UUID_3 = "(journalTemplate.uuid_ IS NULL OR journalTemplate.uuid = '') AND ";
	...
	public List<JournalTemplate> filterFindByGroupId(long groupId, int start,
		...
		if (orderByComparator != null) {
			...
			if (getDB().isSupportsInlineDistinct()) {
				...
				query.append(JournalTemplateModelImpl.ORDER_BY_ENTITY_TABLE);
			}
		}
	...
	public List<JournalTemplate> findAll(int start, int end,
		...
		if (list == null) {
			...
			if (orderByComparator != null) {
				...
				if (pagination) {
					sql = sql.concat(JournalTemplateModelImpl.ORDER_BY_ENTITY_ALIAS);
				}
			}
	...
	public int countAll() throws SystemException {
		...
		if (count == null) {
			...
			try {
				...
				SQLQuery q = session.createSQLQuery(_SQL_COUNT_JOURNALTEMPLATE);
	...
	private static final String _SQL_COUNT_JOURNALTEMPLATE = "SELECT COUNT(*) AS COUNT_VALUE FROM JournalTemplate journalTemplate";
	private static final String _SQL_COUNT_JOURNALTEMPLATE_WHERE = "SELECT COUNT(*) AS COUNT_VALUE FROM JournalTemplate journalTemplate WHERE ";
