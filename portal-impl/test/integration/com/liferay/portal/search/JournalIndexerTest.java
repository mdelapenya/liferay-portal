...
public class JournalIndexerTest {
	...
	public void testDeleteArticles() throws Exception {
		...
		JournalTestUtil.updateArticle(
			article1, article1.getTitle(LocaleUtil.getDefault()), content, false, true,
			serviceContext);
		...
		JournalTestUtil.updateArticle(
			article2, article2.getTitle(LocaleUtil.getDefault()), content, false, true,
			serviceContext);
	...
	public void testIndexVersions() throws Exception {
		...
		article = JournalTestUtil.updateArticle(
			article, article.getTitle(LocaleUtil.getDefault()), article.getContent(), false, true,
			serviceContext);
	...
	protected void articleVersions(boolean delete, boolean all)
		...
		article = JournalTestUtil.updateArticle(
			article, article.getTitle(LocaleUtil.getDefault()), content, false, true, serviceContext);
