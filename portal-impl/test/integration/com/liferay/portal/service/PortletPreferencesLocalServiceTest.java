...
public class PortletPreferencesLocalServiceTest {
	...
	@Test
	public void testGetPreferencesCountByOwnerLayoutPortlet()
		throws Exception {
	...
	@Test
	public void testGetPreferencesCountByOwnerPortlet()
		throws Exception {
	...
	@Test
	public void testGetPreferencesCountByPortletOwnerType()
		throws Exception {
	...
	public void testGetPreferencesByCompanyGroupOwnerPortlet()
		...
		Layout layout2 = addLayout(GroupTestUtil.addGroup());
	...
	public void testGetPreferencesByCompanyOwnerLayoutPortletAdded()
		...
		javax.portlet.PortletPreferences currentPortelPreferences =
			getPreferences(_portlet);

		Assert.assertArrayEquals(
			initialPortletPreferences.getMap().get(_PREFERENCE_NAME),
			currentPortelPreferences.getMap().get(_PREFERENCE_NAME));
	}
	...
	public void testGetPreferencesByPlid() throws Exception {
		...
		addPortletLayoutWithoutDefaultPreferences(layout2, portlets);
	...
	public void testGetPreferencesByPortletOwnerTypeLayout() throws Exception {
		...
		PortletPreferences portletPferencesGroup2 =
			addPortletGroupWithoutDefaultPreferences(group2, _portlet)[0];
	...
	public void testGetPreferencesByPortletPreferencesIds() throws Exception {
		...
		addPortletLayoutPreferences(preferencesAsXML);
