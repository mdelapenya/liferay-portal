...
public class PhonePersistenceTest {
	...
	public void testFindByUuid() throws Exception {
		...
		List<Phone> phones = _persistence.findByUuid(uuid);

		Assert.assertEquals(1, phones.size());

		Assert.assertEquals(phone.getPrimaryKey(), phones.get(0).getPrimaryKey());
	}
	...
	protected void testFindByUuidStartEnd(int start, int end, int expected)
		...
		List<Phone> phones = _persistence.findByUuid(uuid, start, end);

		Assert.assertEquals(expected, phones.size());
	}
	...
	public void testFindByUuid_C() throws Exception {
		...
		List<Phone> phones = _persistence.findByUuid_C(uuid, companyId);
	...
	protected void testFindByUuid_CStartEnd(int start, int end, int expected)
		...
		List<Phone> phones = _persistence.findByUuid_C(uuid, companyId, start,
				end);
	...
	public void testFindByCompanyId() throws Exception {
		...
		List<Phone> phones = _persistence.findByCompanyId(companyId);
	...
	protected void testFindByCompanyIdStartEnd(int start, int end, int expected)
		...
		List<Phone> phones = _persistence.findByCompanyId(companyId, start, end);
	...
	public void testFindByUserId() throws Exception {
		...
		long userId = phone.getUserId();

		List<Phone> phones = _persistence.findByUserId(userId);
	...
	protected void testFindByUserIdStartEnd(int start, int end, int expected)
		...
		List<Phone> phones = _persistence.findByUserId(userId, start, end);
	...
	public void testFindByC_C() throws Exception {
		...
		long classNameId = phone.getClassNameId();

		List<Phone> phones = _persistence.findByC_C(companyId, classNameId);
	...
	public void testFindByC_C_C() throws Exception {
		...
		List<Phone> phones = _persistence.findByC_C_C(companyId, classNameId,
				classPK);
	...
	public void testFindByC_C_C_P() throws Exception {
		...
		List<Phone> phones = _persistence.findByC_C_C_P(companyId, classNameId,
				classPK, primary);
