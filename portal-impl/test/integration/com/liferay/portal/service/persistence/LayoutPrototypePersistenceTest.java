...
public class LayoutPrototypePersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("LayoutPrototype",
				"uuid_", true, "layoutPrototypeId", true, "companyId", true,
				"name", true, "description", true, "settings_", true,
				"active_", true);
