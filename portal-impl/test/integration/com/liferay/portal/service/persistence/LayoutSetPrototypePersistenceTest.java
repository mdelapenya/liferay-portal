...
public class LayoutSetPrototypePersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("LayoutSetPrototype",
				"uuid_", true, "layoutSetPrototypeId", true, "companyId", true,
				"createDate", true, "modifiedDate", true, "name", true,
				"description", true, "settings_", true, "active_", true);
