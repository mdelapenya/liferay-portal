...
public class RepositoryPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("Repository",
				"uuid_", true, "repositoryId", true, "groupId", true,
				"companyId", true, "userId", true, "userName", true,
				"createDate", true, "modifiedDate", true, "classNameId", true,
				"name", true, "description", true, "portletId", true,
				"typeSettings", true, "dlFolderId", true);
