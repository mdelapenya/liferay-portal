...
public class CountryPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("Country",
				"countryId", true, "name", true, "a2", true, "a3", true,
				"number_", true, "idd_", true, "zipRequired", true, "active_",
				true);
