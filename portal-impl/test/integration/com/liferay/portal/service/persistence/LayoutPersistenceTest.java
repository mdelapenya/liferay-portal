...
public class LayoutPersistenceTest {
	...
	public void testFindAll() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("Layout",
				"uuid", true, "plid", true, "groupId", true, "companyId", true,
				...
				true, "type", true, "typeSettings", true, "hidden", true,
				...
				"layoutPrototypeUuid", true, "layoutPrototypeLinkEnabled",
				true, "sourcePrototypeLayoutUuid", true);
