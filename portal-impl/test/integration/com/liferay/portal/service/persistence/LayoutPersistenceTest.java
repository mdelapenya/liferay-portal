...
public class LayoutPersistenceTest {
	...
	public void testFindByUuid() throws Exception {
		...
		List<Layout> layouts = _persistence.findByUuid(uuid);

		Assert.assertEquals(1, layouts.size());

		Assert.assertEquals(layout.getPrimaryKey(),
			layouts.get(0).getPrimaryKey());
	}
	...
	protected void testFindByUuidStartEnd(int start, int end, int expected)
		...
		List<Layout> layouts = _persistence.findByUuid(uuid, start, end);

		Assert.assertEquals(expected, layouts.size());
	}
	...
	public void testFindByUuid_C() throws Exception {
		...
		List<Layout> layouts = _persistence.findByUuid_C(uuid, companyId);
