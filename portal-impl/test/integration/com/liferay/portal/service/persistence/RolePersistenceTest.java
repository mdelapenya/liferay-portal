...
public class RolePersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("Role_",
				"roleId", true, "companyId", true, "classNameId", true,
				"classPK", true, "name", true, "title", true, "description",
				true, "type_", true, "subtype", true);
