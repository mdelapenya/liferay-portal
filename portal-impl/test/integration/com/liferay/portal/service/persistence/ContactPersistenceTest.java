...
public class ContactPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("Contact_",
				"contactId", true, "companyId", true, "userId", true,
				"userName", true, "createDate", true, "modifiedDate", true,
				"classNameId", true, "classPK", true, "accountId", true,
				"parentContactId", true, "emailAddress", true, "firstName",
				true, "middleName", true, "lastName", true, "prefixId", true,
				"suffixId", true, "male", true, "birthday", true, "smsSn",
				true, "aimSn", true, "facebookSn", true, "icqSn", true,
				"jabberSn", true, "msnSn", true, "mySpaceSn", true, "skypeSn",
				true, "twitterSn", true, "ymSn", true, "employeeStatusId",
				true, "employeeNumber", true, "jobTitle", true, "jobClass",
				true, "hoursOfOperation", true);
