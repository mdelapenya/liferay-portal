...
public class ReleasePersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("Release_",
				"releaseId", true, "createDate", true, "modifiedDate", true,
				"servletContextName", true, "buildNumber", true, "buildDate",
				true, "verified", true, "state_", true, "testString", true);
