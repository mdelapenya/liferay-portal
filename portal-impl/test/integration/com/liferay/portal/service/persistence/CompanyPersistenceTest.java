...
public class CompanyPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("Company",
				"companyId", true, "accountId", true, "webId", true, "key_",
				true, "mx", true, "homeURL", true, "logoId", true, "system",
				true, "maxUsers", true, "active_", true);
