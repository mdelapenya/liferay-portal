...
public class UserNotificationEventPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("UserNotificationEvent",
				"uuid_", true, "userNotificationEventId", true, "companyId",
				true, "userId", true, "type_", true, "timestamp", true,
				"deliverBy", true, "payload", true, "archived", true);
