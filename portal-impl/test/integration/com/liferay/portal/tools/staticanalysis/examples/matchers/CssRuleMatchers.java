...
public final class CssRuleMatchers {
	...
	public static FreudExtendedMatcher<CssRule> containsSelector(
		final CssSelector.Type selectorType) {
	...
	public static IntOperatorMatcherBuilder<CssRule> selectors(
		...
		return new IntOperatorMatcherBuilder<CssRule>(
			new IntOperatorMatcherAdapter<CssRule>() {
	...
	public static IntOperatorMatcherBuilder<CssRule> lastIndexOfSelector(
		final CssSelector.Type selectorType) {
		...
		return new IntOperatorMatcherBuilder<CssRule>(
			...
			public String matcherDisplayName() {
				return
					"LastIndexOfCssSelectorType(" + selectorType.name() + ")";
			}
