...
public final class CssSelectorMatchers {
	...
	public static StringMatcherBuilder<CssSelector> selector() {
		return new StringMatcherBuilder<CssSelector>(
			new RegexMatcherAdapter<CssSelector>() {
	...
	private static FreudExtendedMatcher<CssSelector> selectorTypeMatcher(
		final CssSelector.Type type) {
