...
public final class FieldMatchers {
	...
	public static StringMatcherBuilder<Field> fieldName() {
		return new StringMatcherBuilder<Field>(
			new RegexMatcherAdapter<Field>() {
	...
	public static FreudExtendedMatcher<Field> fieldTypeIsSubTypeOf(
		...
		return new FreudExtendedMatcher<Field>() {
			...
			public void describeTo(final Description description) {
				description.appendText(
					"fieldTypeIsSubTypeOf(" + superType.getName() + ")");
			}

		};
	}

	public static FreudExtendedMatcher<Field> fieldTypeMatches(
	...
	public static FreudExtendedMatcher<Field> fieldAnnotation(
	...
	public static FreudExtendedMatcher<Field> fieldAnnotation(
		...
		return new AnnotationFreudExtendedMatcher<Field>(
			valueMatcher, annotationType);
	}

	public static FreudExtendedMatcher<Field> definedWithModifier(
			...
			protected boolean matchesSafely(final Field item) {
				...
				if (declaringClass == null) {
					throw new IllegalStateException(
						"Cannot execute 'declaredMethod()' matcher - iterator" +
						" does not support breadcrumbs");
				}
