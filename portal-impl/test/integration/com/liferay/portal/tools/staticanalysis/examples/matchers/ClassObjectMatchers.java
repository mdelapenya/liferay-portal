...
public final class ClassObjectMatchers {
	...
	public static StringMatcherBuilder<Class> className() {
		return new StringMatcherBuilder<Class>(
			new RegexMatcherAdapter<Class>() {
	...
	public static IntOperatorMatcherBuilder<Class> numberOfConstructors() {
		return new IntOperatorMatcherBuilder<Class>(
			new IntOperatorMatcherAdapter<Class>() {
	...
	public static IntOperatorMatcherBuilder<Class>
		numberOfConstructorWithModifier(final int modifierMask) {
	...
	public static FreudExtendedMatcher<Class> hasConstructor(
		...
		return new FreudExtendedMatcher<Class>() {
			...
			public void describeTo(final Description description) {
				description.appendText(
					"hasConstructor(" + Arrays.toString(parameterTypes) + ")");
			}
		};
	}

	public static FreudExtendedMatcher<Class> hasConstructorWithModifier(
		final int modifierMask) {

		return numberOfConstructorWithModifier(
			modifierMask).greaterThanOrEqualTo(1);
	}

	public static FreudExtendedMatcher<Class> hasDeclaredMethod(
		...
		return new FreudExtendedMatcher<Class>() {
			...
			public void describeTo(final Description description) {
				description.appendText(
					"hasDeclaredMethod(" + methodName + "(" +
					Arrays.toString(parameterTypes) + ")" + ")");
			}
		};
	}

	public static FreudExtendedMatcher<Class> hasDeclaredFieldOfType(
		...
		return new FreudExtendedMatcher<Class>() {
			...
			public void describeTo(final Description description) {
				description.appendText(
					"hasDeclaredFieldOfType(" + fieldType.getName() + ")");
			}

		};
	}

	public static FreudExtendedMatcher<Class> classAnnotation(
	...
	public static FreudExtendedMatcher<Class> classAnnotation(
		...
		return new AnnotationFreudExtendedMatcher<Class>(
			valueMatcher, annotationType);
	}

	private static FreudExtendedMatcher<Class> byModifierMatcher(
		final int modifierMask) {
