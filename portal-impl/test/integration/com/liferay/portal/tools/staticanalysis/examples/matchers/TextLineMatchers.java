...
public final class TextLineMatchers {
	...
	public static StringMatcherBuilder<TextLine> line() {
		...
		return new StringMatcherBuilder<TextLine>(
			new RegexMatcherAdapter<TextLine>() {
	...
	public static IntOperatorMatcherBuilder<TextLine> lineLength() {
		return new IntOperatorMatcherBuilder<TextLine>(
			new IntOperatorMatcherAdapter<TextLine>() {
