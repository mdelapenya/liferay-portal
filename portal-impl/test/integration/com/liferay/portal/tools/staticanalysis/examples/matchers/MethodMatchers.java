...
public final class MethodMatchers {
	...
	public static StringMatcherBuilder<Method> methodName() {
		return new StringMatcherBuilder<Method>(
			new RegexMatcherAdapter<Method>() {
	...
	public static FreudExtendedMatcher<Method> withParams(
		final Class... params) {
	...
	public static IntOperatorMatcherBuilder<Method> numberOfParams() {
		return new IntOperatorMatcherBuilder<Method>(
			new IntOperatorMatcherAdapter<Method>() {
	...
	public static FreudExtendedMatcher<Method> methodAnnotation(
	...
	public static FreudExtendedMatcher<Method> methodAnnotation(
		...
		return new AnnotationFreudExtendedMatcher<Method>(
			valueMatcher, annotationType);
	}

	public static FreudExtendedMatcher<Method> throwsException(
		...
		return new FreudExtendedMatcher<Method>() {
			...
			@Override
			protected boolean matchesSafely(final Method item) {
				for (Class<?> declaredExceptionType :
					item.getExceptionTypes()) {
	...
	public static FreudExtendedMatcher<Method> definedWithModifier(
			...
			protected boolean matchesSafely(final Method item) {
				...
				if (declaringClass == null) {
					throw new IllegalStateException(
						"Cannot execute 'declaredMethod()' matcher - " +
						"iterator does not support breadcrumbs");
				}
