...
public final class PackageDeclarationMatchers {
	...
	public static StringMatcherBuilder<PackageDeclaration>
		packageDeclaration() {

		return new StringMatcherBuilder<PackageDeclaration>(
			new RegexMatcherAdapter<PackageDeclaration>() {

			@Override
			public String getStringToMatch(
				final PackageDeclaration toBeAnalysed) {
	...
	public static IntOperatorMatcherBuilder<PackageDeclaration> packageDepth() {
		return new IntOperatorMatcherBuilder<PackageDeclaration>(
			new IntOperatorMatcherAdapter<PackageDeclaration>() {
