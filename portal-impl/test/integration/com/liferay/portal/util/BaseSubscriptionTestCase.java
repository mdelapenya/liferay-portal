...
public abstract class BaseSubscriptionTestCase {
	...
	public void tearDown() throws Exception {
		UserLocalServiceUtil.deleteUser(subscriptionUser);
	...
	protected void addSusbscriptionUser() throws Exception {
		subscriptionUser = UserTestUtil.addUser();

		subscriptionUser.setEmailAddress("to@test.com");

		subscriptionUser = UserLocalServiceUtil.updateUser(subscriptionUser);
	}
