 ...
 * @author Roberto Díaz
 */
public class BaseModelSubscriptionNotSupportedCondition
	implements IgnoreCondition {

	@Override
	public boolean ignoreTest(Class clazz) {
		BaseModelSubscriptionNotSupported annotation = AnnotationLocator.locate(
			clazz, BaseModelSubscriptionNotSupported.class);
