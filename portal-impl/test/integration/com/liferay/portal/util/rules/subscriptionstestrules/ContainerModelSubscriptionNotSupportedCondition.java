 ...
 * @author Roberto Díaz
 */
public class ContainerModelSubscriptionNotSupportedCondition
	implements IgnoreCondition {

	@Override
	public boolean ignoreTest(Class clazz) {
		ContainerModelSubscriptionNotSupported annotation =
			AnnotationLocator.locate(
				clazz, ContainerModelSubscriptionNotSupported.class);
