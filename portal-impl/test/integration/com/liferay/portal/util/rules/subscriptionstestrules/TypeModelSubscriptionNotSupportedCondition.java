 ...
 * @author Roberto Díaz
 */
public class TypeModelSubscriptionNotSupportedCondition
	implements IgnoreCondition {

	@Override
	public boolean ignoreTest(Class clazz) {
		TypeModelSubscriptionNotSupported annotation = AnnotationLocator.locate(
			clazz, TypeModelSubscriptionNotSupported.class);
