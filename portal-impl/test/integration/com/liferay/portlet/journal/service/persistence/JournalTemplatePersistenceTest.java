...
public class JournalTemplatePersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("JournalTemplate",
				"uuid_", true, "id_", true, "groupId", true, "companyId", true,
				"userId", true, "userName", true, "createDate", true,
				"modifiedDate", true, "templateId", true, "structureId", true,
				"name", true, "description", true, "xsl", true, "langType",
				true, "cacheable", true, "smallImage", true, "smallImageId",
				true, "smallImageURL", true);
