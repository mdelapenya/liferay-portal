...
public class JournalFeedPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("JournalFeed",
				"uuid_", true, "id_", true, "groupId", true, "companyId", true,
				"userId", true, "userName", true, "createDate", true,
				"modifiedDate", true, "feedId", true, "name", true,
				"description", true, "type_", true, "structureId", true,
				"templateId", true, "rendererTemplateId", true, "delta", true,
				"orderByCol", true, "orderByType", true,
