...
public class AnnouncementsEntryPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("AnnouncementsEntry",
				"uuid_", true, "entryId", true, "companyId", true, "userId",
				true, "userName", true, "createDate", true, "modifiedDate",
				true, "classNameId", true, "classPK", true, "title", true,
				"content", true, "url", true, "type_", true, "displayDate",
				true, "expirationDate", true, "priority", true, "alert", true);
