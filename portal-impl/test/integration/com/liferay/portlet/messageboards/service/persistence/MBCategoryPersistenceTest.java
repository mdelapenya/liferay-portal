...
public class MBCategoryPersistenceTest {
	...
	public void testFindByUuid() throws Exception {
		...
		String uuid = mbCategory.getUuid();

		List<MBCategory> mbCategories = _persistence.findByUuid(uuid);

		Assert.assertEquals(1, mbCategories.size());

		Assert.assertEquals(mbCategory.getPrimaryKey(),
			mbCategories.get(0).getPrimaryKey());
	}
	...
	public void testFindByUuidNotFound() throws Exception {
		...
		Assert.assertEquals(0, mbCategories.size());
	}
	...
	protected void testFindByUuidStartEnd(int start, int end, int expected)
		...
		List<MBCategory> mbCategories = _persistence.findByUuid(uuid, start, end);

		Assert.assertEquals(expected, mbCategories.size());
	}
	...
	public void testFindByUuid_C() throws Exception {
		...
		List<MBCategory> mbCategories = _persistence.findByUuid_C(uuid,
				companyId);
