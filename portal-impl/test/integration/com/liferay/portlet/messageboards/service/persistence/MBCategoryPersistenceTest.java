...
public class MBCategoryPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("MBCategory",
				...
				"threadCount", true, "messageCount", true, "lastPostDate",
				true, "status", true, "statusByUserId", true,
