...
public class ExpandoColumnPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("ExpandoColumn",
				"columnId", true, "companyId", true, "tableId", true, "name",
				true, "type_", true, "defaultData", true, "typeSettings", true);
