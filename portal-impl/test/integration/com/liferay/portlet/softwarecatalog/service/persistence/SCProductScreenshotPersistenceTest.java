...
public class SCProductScreenshotPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("SCProductScreenshot",
				"productScreenshotId", true, "companyId", true, "groupId",
				true, "productEntryId", true, "thumbnailId", true,
				"fullImageId", true, "priority", true);
