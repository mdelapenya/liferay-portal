...
public class DDMStructurePersistenceTest {
	...
	public void testFindByUuid() throws Exception {
		...
		String uuid = ddmStructure.getUuid();

		List<DDMStructure> ddmStructures = _persistence.findByUuid(uuid);

		Assert.assertEquals(1, ddmStructures.size());

		Assert.assertEquals(ddmStructure.getPrimaryKey(),
			ddmStructures.get(0).getPrimaryKey());
	}
	...
	protected void testFindByUuidStartEnd(int start, int end, int expected)
		...
		List<DDMStructure> ddmStructures = _persistence.findByUuid(uuid, start,
				end);

		Assert.assertEquals(expected, ddmStructures.size());
	}
	...
	public void testFindByUuid_C() throws Exception {
		...
		List<DDMStructure> ddmStructures = _persistence.findByUuid_C(uuid,
				companyId);
