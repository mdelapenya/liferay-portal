...
public class DDMStructurePersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("DDMStructure",
				"uuid_", true, "structureId", true, "groupId", true,
				"companyId", true, "userId", true, "userName", true,
				"createDate", true, "modifiedDate", true, "parentStructureId",
				true, "classNameId", true, "structureKey", true, "name", true,
				"description", true, "xsd", true, "storageType", true, "type_",
				true);
