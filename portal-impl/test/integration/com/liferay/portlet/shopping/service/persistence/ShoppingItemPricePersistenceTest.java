...
public class ShoppingItemPricePersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("ShoppingItemPrice",
				"itemPriceId", true, "itemId", true, "minQuantity", true,
				"maxQuantity", true, "price", true, "discount", true,
				"taxable", true, "shipping", true, "useShippingFormula", true,
				"status", true);
