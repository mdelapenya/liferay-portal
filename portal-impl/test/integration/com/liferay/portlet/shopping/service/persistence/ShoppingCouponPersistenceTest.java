...
public class ShoppingCouponPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("ShoppingCoupon",
				"couponId", true, "groupId", true, "companyId", true, "userId",
				true, "userName", true, "createDate", true, "modifiedDate",
				true, "code_", true, "name", true, "description", true,
				"startDate", true, "endDate", true, "active_", true,
