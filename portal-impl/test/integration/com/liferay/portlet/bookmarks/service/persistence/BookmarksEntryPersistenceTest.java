...
public class BookmarksEntryPersistenceTest {
	...
	public void testFindAll() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("BookmarksEntry",
				"uuid", true, "entryId", true, "groupId", true, "companyId",
				true, "userId", true, "userName", true, "createDate", true,
				"modifiedDate", true, "resourceBlockId", true, "folderId",
				true, "name", true, "url", true, "description", true, "visits",
				true, "priority", true, "status", true, "statusByUserId", true,
