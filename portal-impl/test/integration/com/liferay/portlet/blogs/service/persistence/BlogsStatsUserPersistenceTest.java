...
public class BlogsStatsUserPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("BlogsStatsUser",
				"statsUserId", true, "groupId", true, "companyId", true,
				"userId", true, "entryCount", true, "lastPostDate", true,
