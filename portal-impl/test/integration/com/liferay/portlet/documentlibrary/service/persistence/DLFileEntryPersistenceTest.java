...
public class DLFileEntryPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("DLFileEntry",
				"uuid_", true, "fileEntryId", true, "groupId", true,
				"companyId", true, "userId", true, "userName", true,
				"versionUserId", true, "versionUserName", true, "createDate",
				true, "modifiedDate", true, "classNameId", true, "classPK",
				true, "repositoryId", true, "folderId", true, "name", true,
				"extension", true, "mimeType", true, "title", true,
				"description", true, "extraSettings", true, "fileEntryTypeId",
				true, "version", true, "size_", true, "readCount", true,
				"smallImageId", true, "largeImageId", true, "custom1ImageId",
