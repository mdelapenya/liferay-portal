...
public class DLFolderPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("DLFolder",
				...
				"lastPostDate", true, "defaultFileEntryTypeId", true,
				"hidden_", true, "overrideFileEntryTypes", true, "status",
