...
public class DLFileRankPersistenceTest {
	...
	public void testFindAll() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("DLFileRank",
				"uuid", true, "fileRankId", true, "groupId", true, "companyId",
				true, "userId", true, "userName", true, "createDate", true,
				"modifiedDate", true, "fileEntryId", true, "active", true);
