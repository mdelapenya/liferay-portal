...
public class DLFileVersionPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("DLFileVersion",
				"uuid_", true, "fileVersionId", true, "groupId", true,
				"companyId", true, "userId", true, "userName", true,
				"createDate", true, "modifiedDate", true, "repositoryId", true,
				"folderId", true, "fileEntryId", true, "extension", true,
				"mimeType", true, "title", true, "description", true,
				"changeLog", true, "extraSettings", true, "fileEntryTypeId",
				true, "version", true, "size_", true, "checksum", true,
				"status", true, "statusByUserId", true, "statusByUserName",
