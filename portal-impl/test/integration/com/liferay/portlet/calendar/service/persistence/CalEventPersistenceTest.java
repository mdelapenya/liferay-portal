...
public class CalEventPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("CalEvent",
				"uuid_", true, "eventId", true, "groupId", true, "companyId",
				...
				"timeZoneSensitive", true, "type_", true, "repeating", true,
				"recurrence", true, "remindBy", true, "firstReminder", true,
				"secondReminder", true);
