...
public class AssetEntryPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("AssetEntry",
				...
				"classTypeId", true, "visible", true, "startDate", true,
				"endDate", true, "publishDate", true, "expirationDate", true,
				"mimeType", true, "title", true, "description", true,
				"summary", true, "url", true, "layoutUuid", true, "height",
