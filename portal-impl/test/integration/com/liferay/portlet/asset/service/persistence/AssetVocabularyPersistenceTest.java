...
public class AssetVocabularyPersistenceTest {
	...
	public void testFindByUuid() throws Exception {
		...
		String uuid = assetVocabulary.getUuid();

		List<AssetVocabulary> assetVocabularies = _persistence.findByUuid(uuid);

		Assert.assertEquals(1, assetVocabularies.size());

		Assert.assertEquals(assetVocabulary.getPrimaryKey(),
			assetVocabularies.get(0).getPrimaryKey());
	}
	...
	public void testFindByUuidNotFound() throws Exception {
		...
		Assert.assertEquals(0, assetVocabularies.size());
	}
	...
	protected void testFindByUuidStartEnd(int start, int end, int expected)
		...
		Assert.assertEquals(expected, assetVocabularies.size());
	}
	...
	public void testFindByUuid_C() throws Exception {
		...
		List<AssetVocabulary> assetVocabularies = _persistence.findByUuid_C(uuid,
				companyId);
