...
public class AssetCategoryPersistenceTest {
	...
	public void testFindByUuid() throws Exception {
		...
		List<AssetCategory> assetCategories = _persistence.findByUuid(uuid);

		Assert.assertEquals(1, assetCategories.size());

		Assert.assertEquals(assetCategory.getPrimaryKey(),
			assetCategories.get(0).getPrimaryKey());
	}
	...
	protected void testFindByUuidStartEnd(int start, int end, int expected)
		...
		Assert.assertEquals(expected, assetCategories.size());
	}
	...
	public void testFindByUuid_C() throws Exception {
		...
		List<AssetCategory> assetCategories = _persistence.findByUuid_C(uuid,
				companyId);
