...
public class PollsQuestionPersistenceTest {
	...
	public void testFindAllOrderBy() throws Exception {
		OrderByComparator obc = OrderByComparatorFactoryUtil.create("PollsQuestion",
				"uuid_", true, "questionId", true, "groupId", true,
				"companyId", true, "userId", true, "userName", true,
				"createDate", true, "modifiedDate", true, "title", true,
				"description", true, "expirationDate", true, "lastVoteDate",
				true);
