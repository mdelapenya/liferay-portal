		...
		<c:if test='<%= ArrayUtil.contains(metadataFields, String.valueOf("author")) %>'>
			<div class="asset-author">
				...
				if (assetEntry.getPublishDate() != null) {
					displayDate = LanguageUtil.format(request, "x-ago", LanguageUtil.getTimeDescription(pageContext, System.currentTimeMillis() - assetEntry.getPublishDate().getTime(), true), false);
				}
				else if (assetEntry.getModifiedDate() != null) {
					displayDate = LanguageUtil.format(request, "x-ago", LanguageUtil.getTimeDescription(pageContext, System.currentTimeMillis() - assetEntry.getModifiedDate().getTime(), true), false);
				}
				%>
